...
export const viewport = {
  themeColor: [
    { media: '(prefers-color-scheme: light)', color: 'white' }, // Adjust this color as needed for your light theme
  ],
};
        ...
        <AI>
          <Providers attribute="class" defaultTheme="light" enableSystem disableTransitionOnChange>
            <div className="flex flex-col min-h-screen">
              <Header />
              <main className="flex flex-col flex-1 bg-muted/50"> {/* Ensure this is appropriate for a light theme */}
                {children}
              </main>
            </div>
          </Providers>
